...
<body>
    ...
    <div class="overlay"></div>
		<div class="home-content">
			<div class="home-img ">
				<img src="<?=base_url('files/imgs/D-apps.png')?>" alt="">
			</div>
			<div class="home-text ">
        ...
        <div id='myworks' class="row no-gutters">
          <?php foreach ($works as $work): ?>
            <div class=" col-sm-6 col-lg-4  item zoom-on-hover wow animate__animated animate__fadeInUp ">
                <a class="lightbox works-link" href="<?=base_url() . 'files/imgs/works images/' . $work->img . ''?>">
                    <img class="img-fluid image" src="<?=base_url() . 'files/imgs/works images/' . $work->img . ''?>">
                </a>
                <!-- <p class="m-auto p-1 work-description"><?=$work->description?></p> -->
        </div>
        <?php endforeach;?>
        </div>
		<!-- See More Works -->
                        ...
                        <div class="card-body contact text-center h-100 white-text">
                            ...
                            <div class="roz-socila-media">
                                <ul class=" text-center">
                                    ...
                                    <li>
                                        <a target="_blank"  href="https://www.instagram.com/r0_ozy/"><i class="fab fa-instagram icon"></i></a>
									</li>
                                    <li>
                                        <a target="_blank" href="https://twitter.com/r0_ozy"><i class="fab fa-twitter icon"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <footer class="roz-footer">
        <div class="row">
                ...
                <div class="col-md-4 ">Design & Prog:
                    <a href="https://hamza-mughales.4dev.biz/" class="hamza-design"  target="_blank">Hamza Mughales</a>
                </div>
            </div>
	</footer>
